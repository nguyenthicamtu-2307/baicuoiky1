...
public class NhanVien extends JFrame {
	...
	public void initialize() {
		...
		JComboBox loaiHang = new JComboBox();
		loaiHang.setBounds(106, 119, 111, 19);
		NH.add(loaiHang);
		...
		btnNewButton_1_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (maHang.getText().isEmpty() || tenHang.getText().isEmpty() || soLuong.getText().isEmpty()
					...
					hangHoa.setLoaiHang(loaiHang.getSelectedItem().toString());
		...
		lblNewLabel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				NhanVien.repaint();
				NhanVien.revalidate();
				List<String> listLoaiHang = controller.getDataIntoComboBox();
		...
		table_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				loaiHang.setSelectedItem((String) table_2.getValueAt(table_2.getSelectedRow(), 3));
